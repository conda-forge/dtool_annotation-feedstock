About dtool_annotation-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dtool_annotation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dtool_annotation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dtool_annotation
# for installing globally
pixi global install dtool_annotation
```
...
It is possible to list all of the versions of `dtool_annotation` available on your platform:
...
```
pixi search dtool_annotation --channel conda-forge
```
