...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtool_annotation-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13112&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtool_annotation-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtool_annotation` can be installed with:

```
conda install dtool_annotation
```

It is possible to list all of the versions of `dtool_annotation` available on your platform with:
